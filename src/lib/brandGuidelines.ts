// lib/brandGuidelines.ts

export const brandGuidelines = `## **Overview**

You're overworked and under-resourced. Is your marketing automation platform (MAP) helping you get more done? We're Act-On, and we built the easiest to use, most intelligent marketing automation platform because we want to help every marketer get more done. Go from idea to impact in record time, with Al-driven marketing automation that puts you back in the driver's seat.

When you choose Act-On, buying the software is only the beginning of a longer relationship. We provide knowledgeable support that can quickly resolve any marketing challenge. If that's not enough, our extensive partner and professional services ecosystem unlocks even more marketing possibilities.

Act confidently, knowing you're supported by an organization focused on helping marketers grow revenue.

This is Marketing Automation reimagined.
